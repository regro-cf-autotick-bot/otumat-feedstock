...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/otumat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12558&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/otumat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `otumat` can be installed with:

```
conda install otumat
```

It is possible to list all of the versions of `otumat` available on your platform with:
